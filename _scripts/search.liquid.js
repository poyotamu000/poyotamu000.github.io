...
ninja.data = [
  ...
  {%- if site.socials_in_search -%}
    {%- for social in site.data.socials -%}
      {%- assign social_value = social[1].value | default: social[1] -%}
      {%- case social[0] -%}
        {%- when "acm_id" -%}
          {%- assign social_id = "social-acm" -%}
          {%- assign social_title = "ACM DL" -%}
          {%- capture social_url %}"https://dl.acm.org/profile/{{ social_value }}/"{% endcapture -%}
        {%- when "arxiv_id" -%}
          {%- assign social_id = "social-arxiv" -%}
          {%- assign social_title = "arXiv" -%}
          {%- capture social_url %}"https://arxiv.org/a/{{ social_value }}.html"{% endcapture -%}
        {%- when "blogger_url" -%}
          {%- assign social_id = "social-blogger" -%}
          {%- assign social_title = "Blogger" -%}
          {%- capture social_url %}"{{ social_value }}"{% endcapture -%}
        {%- when "bluesky_url" -%}
        ...
        {%- when "cv_pdf" -%}
          ...
          {%- capture social_url %}"{{ social_value | relative_url }}"{% endcapture -%}
        {%- when "dblp_url" -%}
        ...
        {%- when "discord_id" -%}
          ...
          {%- capture social_url %}"https://discord.com/users/{{ social_value }}"{% endcapture -%}
        {%- when "email" -%}
          {%- assign social_id = "social-email" -%}
          {%- assign social_title = "email" -%}
          {%- capture social_url %}"mailto:{{ social_value | encode_email }}"{% endcapture -%}
        {%- when "facebook_id" -%}
          {%- assign social_id = "social-facebook" -%}
          {%- assign social_title = "Facebook" -%}
          {%- capture social_url %}"https://facebook.com/{{ social_value }}"{% endcapture -%}
        {%- when "flickr_id" -%}
          {%- assign social_id = "social-flickr" -%}
          {%- assign social_title = "Flickr" -%}
          {%- capture social_url %}"https://www.flickr.com/{{ social_value }}"{% endcapture -%}
        {%- when "github_username" -%}
          {%- assign social_id = "social-github" -%}
          {%- assign social_title = "GitHub" -%}
          {%- capture social_url %}"https://github.com/{{ social_value }}"{% endcapture -%}
        {%- when "gitlab_username" -%}
          {%- assign social_id = "social-gitlab" -%}
          {%- assign social_title = "GitLab" -%}
          {%- capture social_url %}"https://gitlab.com/{{ social_value }}"{% endcapture -%}
        {%- when "hal_id" -%}
          {%- assign social_id = "social-hal" -%}
          {%- assign social_title = "HAL" -%}
          {%- capture social_url %}"https://cv.hal.science/{{ social_value }}"{% endcapture -%}
        {%- when "ieee_id" -%}
          {%- assign social_id = "social-ieee" -%}
          {%- assign social_title = "IEEE Xplore" -%}
          {%- capture social_url %}"https://ieeexplore.ieee.org/author/{{ social_value }}/"{% endcapture -%}
        {%- when "inspirehep_id" -%}
          {%- assign social_id = "social-inspire" -%}
          {%- assign social_title = "Inspire HEP" -%}
          {%- capture social_url %}"https://inspirehep.net/authors/{{ social_value }}"{% endcapture -%}
        {%- when "instagram_id" -%}
          {%- assign social_id = "social-instagram" -%}
          {%- assign social_title = "Instagram" -%}
          {%- capture social_url %}"https://instagram.com/{{ social_value }}"{% endcapture -%}
        {%- when "kaggle_id" -%}
          {%- assign social_id = "social-kaggle" -%}
          {%- assign social_title = "Kaggle" -%}
          {%- capture social_url %}"https://www.kaggle.com/{{ social_value }}"{% endcapture -%}
        {%- when "keybase_username" -%}
          {%- assign social_id = "social-keybase" -%}
          {%- assign social_title = "Keybase" -%}
          {%- capture social_url %}"https://keybase.io/{{ social_value }}"{% endcapture -%}
        {%- when "lastfm_id" -%}
          {%- assign social_id = "social-lastfm" -%}
          {%- assign social_title = "Last FM" -%}
          {%- capture social_url %}"https://www.last.fm/user/{{ social_value }}"{% endcapture -%}
        {%- when "lattes_id" -%}
          {%- assign social_id = "social-lattes" -%}
          {%- assign social_title = "Lattes" -%}
          {%- capture social_url %}"https://lattes.cnpq.br/{{ social_value }}"{% endcapture -%}
        {%- when "leetcode_id" -%}
          {%- assign social_id = "social-leetcode" -%}
          {%- assign social_title = "LeetCode" -%}
          {%- capture social_url %}"https://leetcode.com/u/{{ social_value }}/"{% endcapture -%}
        {%- when "linkedin_username" -%}
          {%- assign social_id = "social-linkedin" -%}
          {%- assign social_title = "LinkedIn" -%}
          {%- capture social_url %}"https://www.linkedin.com/in/{{ social_value }}"{% endcapture -%}
        {%- when "mastodon_username" -%}
          {%- assign social_id = "social-mastodon" -%}
          {%- assign social_title = "Mastodon" -%}
          {%- capture social_url %}"https://{{ social_value }}"{% endcapture -%}
        {%- when "medium_username" -%}
          {%- assign social_id = "social-medium" -%}
          {%- assign social_title = "Medium" -%}
          {%- capture social_url %}"https://medium.com/@{{ social_value }}"{% endcapture -%}
        {%- when "orcid_id" -%}
          {%- assign social_id = "social-orcid" -%}
          {%- assign social_title = "ORCID" -%}
          {%- capture social_url %}"https://orcid.org/{{ social_value }}"{% endcapture -%}
        {%- when "osf_id" -%}
          {%- assign social_id = "social-osf" -%}
          {%- assign social_title = "Open Science Framework" -%}
          {%- capture social_url %}"https://osf.io/{{ social_value }}/"{% endcapture -%}
        {%- when "pinterest_id" -%}
          {%- assign social_id = "social-pinterest" -%}
          {%- assign social_title = "Pinterest" -%}
          {%- capture social_url %}"https://www.pinterest.com/{{ social_value }}"{% endcapture -%}
        {%- when "publons_id" -%}
          {%- assign social_id = "social-publons" -%}
          {%- assign social_title = "Publons" -%}
          {%- capture social_url %}"https://publons.com/a/{{ social_value }}/"{% endcapture -%}
        {%- when "quora_username" -%}
          {%- assign social_id = "social-quora" -%}
          {%- assign social_title = "Quora" -%}
          {%- capture social_url %}"https://www.quora.com/profile/{{ social_value }}"{% endcapture -%}
        {%- when "research_gate_profile" -%}
          {%- assign social_id = "social-researchgate" -%}
          {%- assign social_title = "ResearchGate" -%}
          {%- capture social_url %}"https://www.researchgate.net/profile/{{ social_value }}/"{% endcapture -%}
        {%- when "rss_icon" -%}
        ...
        {%- when "scholar_userid" -%}
          ...
          {%- capture social_url %}"https://scholar.google.com/citations?user={{ social_value }}"{% endcapture -%}
        {%- when "scopus_id" -%}
          {%- assign social_id = "social-scopus" -%}
          {%- assign social_title = "Scopus" -%}
          {%- capture social_url %}"https://www.scopus.com/authid/detail.uri?authorId={{ social_value }}"{% endcapture -%}
        {%- when "semanticscholar_id" -%}
          {%- assign social_id = "social-semanticscholar" -%}
          {%- assign social_title = "Semantic Scholar" -%}
          {%- capture social_url %}"https://www.semanticscholar.org/author/{{ social_value }}"{% endcapture -%}
        {%- when "spotify_id" -%}
          {%- assign social_id = "social-spotify" -%}
          {%- assign social_title = "Spotify" -%}
          {%- capture social_url %}"https://open.spotify.com/user/{{ social_value }}"{% endcapture -%}
        {%- when "stackoverflow_id" -%}
          {%- assign social_id = "social-stackoverflow" -%}
          {%- assign social_title = "Stackoverflow" -%}
          {%- capture social_url %}"https://stackoverflow.com/users/{{ social_value }}"{% endcapture -%}
        {%- when "strava_userid" -%}
          {%- assign social_id = "social-strava" -%}
          {%- assign social_title = "Strava" -%}
          {%- capture social_url %}"https://www.strava.com/athletes/{{ social_value }}"{% endcapture -%}
        {%- when "telegram_username" -%}
          {%- assign social_id = "social-telegram" -%}
          {%- assign social_title = "telegram" -%}
          {%- capture social_url %}"https://telegram.me/{{ social_value }}"{% endcapture -%}
        {%- when "unsplash_id" -%}
          {%- assign social_id = "social-unsplash" -%}
          {%- assign social_title = "Unsplash" -%}
          {%- capture social_url %}"https://unsplash.com/@{{ social_value }}"{% endcapture -%}
        {%- comment -%}
        // check how to add wechat qr code
        {%- when "wechat_qr" -%}
          {%- assign social_id = "social-wechat" -%}
          {%- assign social_title = "WeChat" -%}
          {%- capture social_url %}"https://wechat.com/{{ social_value }}"{% endcapture -%}
        {%- endcomment -%}
        {%- when "whatsapp_number" -%}
          {%- assign social_id = "social-whatsapp" -%}
          {%- assign social_title = "whatsapp" -%}
          {%- capture social_url %}"https://wa.me/{{ social_value }}"{% endcapture -%}
        {%- when "wikidata_id" -%}
          {%- assign social_id = "social-wikidata" -%}
          {%- assign social_title = "Wikidata" -%}
          {%- capture social_url %}"https://www.wikidata.org/wiki/{{ social_value }}"{% endcapture -%}
        {%- when "wikipedia_id" -%}
          {%- assign social_id = "social-wikipedia" -%}
          {%- assign social_title = "Wikipedia" -%}
          {%- capture social_url %}"https://wikipedia.org/wiki/User:{{ social_value }}"{% endcapture -%}
        {%- when "work_url" -%}
        ...
        {%- when "x_username" -%}
          ...
          {%- capture social_url %}"https://twitter.com/{{ social_value }}"{% endcapture -%}
        {%- when "youtube_id" -%}
          {%- assign social_id = "social-youtube" -%}
          {%- assign social_title = "YouTube" -%}
          {%- capture social_url %}"https://youtube.com/@{{ social_value }}"{% endcapture -%}
        {%- when "zotero_username" -%}
          {%- assign social_id = "social-zotero" -%}
          {%- assign social_title = "Zotero" -%}
          {%- capture social_url %}"https://www.zotero.org/{{ social_value }}"{% endcapture -%}
        {%- else -%}
